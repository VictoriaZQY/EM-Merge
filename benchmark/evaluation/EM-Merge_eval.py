...
from logparser.EM-Merge import LogParser
...
if __name__ == "__main__":
    ...
    output_dir = f"../../result/result_EMMerge_{data_type}_{args.shot}_{args.example_size}_{args.model}"
    ...
    post_average(metric_file, f"EMMerge_{data_type}_complex={args.complex}_frequent={args.frequent}_{args.shot}_{args.example_size}_{args.model}", args.complex, args.frequent)
